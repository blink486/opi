...
class AddSrvImagesBkp extends StatefulWidget {
  final String name;
  ...
  @override
  _AddSrvImagesBkpState createState() => _AddSrvImagesBkpState();
}

class _AddSrvImagesBkpState extends State<AddSrvImagesBkp> {
